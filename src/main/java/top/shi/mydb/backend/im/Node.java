 ...
 */
public class Node {
    static final int IS_LEAF_OFFSET = 0;//叶子节点
    static final int NO_KEYS_OFFSET = IS_LEAF_OFFSET+1;//该节点中key的个数
    static final int SIBLING_OFFSET = NO_KEYS_OFFSET+2;//其兄弟节点存储在 DM 中的 UID
    ...
    //2 寻找对应 key 的 UID, 如果找不到, 则返回兄弟节点的 UID。
    ...
    public InsertAndSplitRes insertAndSplit(long uid, long key) throws Exception {
        ...
        try {
            ...
            if(err == null && success) {
                ...
                dataItem.unBefore();// 如果失败, 则复原当前节点
            }
        }
    }
